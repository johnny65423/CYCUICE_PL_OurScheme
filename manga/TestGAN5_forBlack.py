...
path = r"E:\manga\sketch_9000up\output0528"
path2 = r"E:\manga\sketch_9000up\output0528"
...
print(paths_subset, paths_subset2)
...
class ColorizationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ab = img_lab2[[0], ...] / 50. - 1.
        #b = img_lab2[[1, 2], ...] / 110.  # Between -1 and 1
        if self.cuda:
            L = L.to(device)
            #RL = RL.to(device)
            ab = ab.to(device)
...
model2.load_state_dict(torch.load(r'E:\manga\OnePiece0712.pth'))
for data in tqdm(train_dl):
    visualize(model2, data, save=False)
#class Unet(nn.Module):